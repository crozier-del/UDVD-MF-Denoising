...
def main(args):
    ...
    with tifffile.TiffWriter(data[:-4]+'_n2s' +'.tif') as stack:
        stack.save(denoised)
        
    print('Denoised Prediction Saved at ', data[:-4]+'_n2s' +'.tif')
...
def get_args():
    ...
    parser.add_argument(
        "--data",
        default="/scratch/sk10640/PtCeO2.tif",
